...
- 以下是进入L2的步骤：
  ...
  1. link一侧的device1受到更高层指示，在所有lanes上发送EIOS，而后进入Electrical Idle
  1. 另一侧的device2接收到EIOS，而后在所有lanes上发送EIOSQ，而后立即进入L1
  1. device1等待任意lane上接收到EIOS，而后进入L1
## L0s
...
- 不管当前的Link Speed，Loopback lead发送如下OS，而后在2ms内进入Electrical Idle
  ...
  1. 对于支持2.5 GT/s以上速率的ports，发送8个连续的EIOS
